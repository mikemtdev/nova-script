...
"apt install https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-$(rpm -E %fedora).noarch.rpm" "dnf install https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-$(rpm -E %fedora).noarch.rpm"
...
# Software
( "curl" "vlc" "gnome-tweaks" "transmission" "uget" "ugetIntegratorInstall" "codec2" )

# Clean up
sudo mv install_uget_integrator.sh /tetempfiles
